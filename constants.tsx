...
export const PLACEHOLDER_FOOD_IMAGE = 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500&auto=format&fit=crop';

/**
 * Converte links de visualização do Google Drive em links diretos para imagem.
 * Ex: drive.google.com/file/d/ID/view -> drive.google.com/uc?export=view&id=ID
 */
export const formatImageUrl = (url: string | undefined): string => {
  if (!url) return PLACEHOLDER_FOOD_IMAGE;
...
export const Icons = {
  ...
  View: ({ size = 20, strokeWidth = 2, className = '', ...props }: any) => (
    <svg
  ...
  ViewOff: ({ size = 20, strokeWidth = 2, className = '', ...props }: any) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
      ...
      {...props}
    >
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.049m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
    </svg>
  ),
  Print: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
  ...
  Alert: ({ size = 20, className = '', ...props }: any) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
  ...
  User: ({ size = 20, className = '', ...props }: any) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
  ...
  CreditCard: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
  ),
  QrCode: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 3h7v7H3V3zm11 0h7v7h-7V3zM3 14h7v7H3v-7zM5 5h3v3H5V5zm11 0h3v3h-3V5zm-11 11h3v3H5v-3zm7-3h2v2h-2v-2zm4 0h2v2h-2v-2zm-4 4h2v2h-2v-2zm4 4h2v2h-2v-2zm0-4h2v2h-2v-2zm-4 0h2v2h-2v-2zm8-5v2m-2-2v2m-2 2v2m2 2v2m2-2v2m-4 0h2v2h-2v-2z" />
    </svg>
  ),
